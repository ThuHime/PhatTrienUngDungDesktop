    ...
    public partial class frmNhatKy : Form
    {
        ...
        private void LoadNhatKyMuaHang(string maBan)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                lblThongKe.Font = new Font("Consolas", 10);
                lblThongKe.Text = $"{"Số HĐ:".PadRight(15)}{tongHoaDon}\n" +
                                $"{"Tổng tiền:".PadRight(15)}{tongTien:#,##0}đ\n" +
                                $"{"Tổng thuế:".PadRight(15)}{tongThue}%\n" +
                                $"{"Tổng giảm giá:".PadRight(15)}{tongGiamGia}%";
            }
        }
